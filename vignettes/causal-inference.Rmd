...
m <- m_estimate(stacked_equations = psi, init = c(0, 0, 0, 0, 0, 0, 0))
...
m <- m_estimate(stacked_equations = psi, init = c(0, 0, 0, 0, 0, 0))
...
m_gformula <- m_estimate(stacked_equations = psi_gformula, init = rep(0, 7))

psi_ipw <- function(theta) {
  ee_ipw(theta, y = Y, A = A, W = cbind(1, W1, W2))
}
m_ipw <- m_estimate(stacked_equations = psi_ipw, init = rep(0, 6))
...
m_aipw <- m_estimate(stacked_equations = psi_aipw, init = rep(0, 10))
