...
code that requires a plain number, so the call fails with `Non-numeric argument
to mathematical function` instead of returning a derivative. deli exports a
counterpart for each one:
