...
estr <- MEstimator(stacked_equations = psi, init = c(0, 0))
estr <- estimate(estr)
estr@theta
...
estr <- MEstimator(stacked_equations = psi, init = c(1))
estr <- estimate(estr)
estr@theta
confidence_intervals(estr)
```
...
estr <- MEstimator(stacked_equations = psi, init = c(10, 5, 2))
estr <- estimate(estr)
estr@theta
confidence_intervals(estr)
```
...
estr <- MEstimator(stacked_equations = psi, init = c(0))
estr <- estimate(estr)
estr@theta
confidence_intervals(estr)
```
...
estr <- MEstimator(stacked_equations = psi, init = c(-1, 0))
estr <- estimate(estr)
estr@theta
confidence_intervals(estr)
```
...
estr <- MEstimator(stacked_equations = psi, init = c(0.3, 0))
estr <- estimate(estr)
estr@theta
confidence_intervals(estr)
```
