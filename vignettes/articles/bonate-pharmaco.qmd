...
estr <- MEstimator(stacked_equations = psi, init = c(-40, 5)) |> estimate()

# View results
estr@theta
sqrt(diag(estr@variance))
confint(estr)
```
...
# Estimate the parameters
estr <- MEstimator(stacked_equations = psi_robust, init = c(-40, 5)) |>
...
# Estimate the parameters
estr <- MEstimator(stacked_equations = psi, init = c(0, 60, 0.5)) |>
  estimate(solver = "nleqslv")
...
# Estimate the parameters
estr <- MEstimator(stacked_equations = psi_c, init = c(0, 60, 0.5)) |>
  estimate(solver = "nleqslv")
...
# Estimate the parameters
estr_null <- MEstimator(stacked_equations = psi, init = c(0)) |> estimate()
estr_null@theta
```
...
# Estimate the parameters
estr_full <- MEstimator(stacked_equations = psi, init = c(0, 0, 0, 0, 0)) |>
  estimate()
estr_full@theta
```
...
# Estimate the parameters
estr_redu <- MEstimator(stacked_equations = psi, init = c(0, 0, 0)) |>
  estimate()
estr_redu@theta
```
...
# Estimate the parameters
estr_prob <- MEstimator(stacked_equations = psi, init = c(0, 0, 0)) |>
  estimate()
estr_prob@theta
```
...
# Estimate the parameters
estr_clog <- MEstimator(stacked_equations = psi, init = c(0, 0, 0)) |>
  estimate()
estr_clog@theta
```
