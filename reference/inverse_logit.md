...
[`stats::plogis()`](https://rdrr.io/r/stats/Logistic.html) and returns
...
`inverse_logit()` is written as `1 / (1 + exp(-logodds))`, so those
group generic methods carry a tangent through it;
[`plogis()`](https://rdrr.io/r/stats/Logistic.html) hands its argument
to compiled code without dispatching, and errors on a tangent-carrying
argument. Use `inverse_logit()` inside estimating equations and inside
transforms passed to
[`delta_method()`](https://r-causal.github.io/deli/reference/delta_method.md),
and [`plogis()`](https://rdrr.io/r/stats/Logistic.html) for ordinary
numeric work.
...
| `inverse_logit()` | [`stats::plogis()`](https://rdrr.io/r/stats/Logistic.html) | errors |
...
[`stats::plogis()`](https://rdrr.io/r/stats/Logistic.html), the base R
equivalent for ordinary numeric work, and
[`logit()`](https://r-causal.github.io/deli/reference/logit.md), which
