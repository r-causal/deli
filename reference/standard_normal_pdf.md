...
[`stats::dnorm()`](https://rdrr.io/r/stats/Normal.html) at the default
...
and `standard_normal_pdf()` recognizes a tangent-carrying argument and
applies the analytic rule itself, \\-x\\ times the density.
[`dnorm()`](https://rdrr.io/r/stats/Normal.html) hands its argument to
compiled code without dispatching, and errors on such an argument. Use
`standard_normal_pdf()` inside estimating equations and inside
transforms passed to
[`delta_method()`](https://r-causal.github.io/deli/reference/delta_method.md),
and [`dnorm()`](https://rdrr.io/r/stats/Normal.html) for ordinary
numeric work.
...
| `standard_normal_pdf()` | [`stats::dnorm()`](https://rdrr.io/r/stats/Normal.html) | errors |
...
[`stats::dnorm()`](https://rdrr.io/r/stats/Normal.html), the base R
